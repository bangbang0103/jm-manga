...
void main() {
  group('AppTheme', () {
    ...
    test('dark theme color scheme has expected primary and surface', () {
      final theme = AppTheme.dark();
      expect(theme.colorScheme.primary, const Color(0xFFFFB85C));
      expect(theme.colorScheme.surface, const Color(0xFF1A1512));
    });
    ...
    test('light theme surface is light', () {
      final theme = AppTheme.light();
      expect(theme.colorScheme.surface, const Color(0xFFFFF8ED));
    });
  });
}
